...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class SetBlendWeights : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			...
			if (level.Value == 1) QualitySettings.skinWeights = SkinWeights.OneBone;
			if (level.Value == 2) QualitySettings.skinWeights = SkinWeights.TwoBones;
			if (level.Value == 4) QualitySettings.skinWeights = SkinWeights.FourBones;
