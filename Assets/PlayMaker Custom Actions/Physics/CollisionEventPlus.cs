        ...
        public override void DoParticleCollision(GameObject other)
        {
            if (collision == CollisionType.OnParticleCollision)
            {
                switch (options)
                {
                    case Options.ColliderOnly:
                        //set
                        if (other.GetComponent<Collider>().gameObject.tag == collideTag.Value)
                        {
                    ...
                    case Options.LayerOnly:
                        //set
                        if (other.GetComponent<Collider>().gameObject.layer == collideLayer.Value)
                        {
                            if (other.tag == collideTag.Value)
                            {
                                if (storeCollideObject != null)
                    ...
                    case Options.ColliderOrLayer:
                        //set
                        if (other.GetComponent<Collider>().gameObject.tag == collideTag.Value || other.GetComponent<Collider>().gameObject.layer == collideLayer.Value)
                        {
                            if (other.tag == collideTag.Value)
                            {
                                if (storeCollideObject != null)
